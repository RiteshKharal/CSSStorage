  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className={filterOpen ? "text-foreground/80" : "text-foreground/60"}>
            <span className="text-foreground/90 font-bold mr-3">Category:</span> {CategoryFilter ? CategoryFilter : "None"}
          </span>
          <ChevronDown
      ...
      >
        ...
        {filterOpen && (
          <div className="absolute top-full left-0 mt-2 w-44 bg-background rounded-xl shadow-md border border-border/40 z-99">
